...
export default function Footer() {
  ...
  const contactInfo = [
    {
      icon: <MdEmail />,
      value: "priyanka.singh.2907.2k@gmail.com",
    },
    {
      icon: <MdPhoneInTalk />,
      value: "6205956258",
    },
    {
      ...
      value: "Near Bank of India , Govindpur ,Dhanbad , Jharkhand ,828109",
    },
  ];
  const socialIcons = [
    <AiFillFacebook />,
    ...
    <Container>
      <div className="row">
        ...
        <p className="description">
          Near Bank of India , Govindpur ,Dhanbad , Jharkhand ,828109
        </p>
